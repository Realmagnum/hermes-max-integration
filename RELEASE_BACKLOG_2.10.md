...
**Статус на 26.09.2026:** заблокировано внешней поставкой: в публичном индексе доступен только `hermes-agent` 0.19.0. Обновление или подмена зависимости без опубликованного совместимого Core не выполняются.
...
**Статус на 26.09.2026:** заблокировано инфраструктурой: на `a1.rmg7.com` нет изолированного MAX gateway/контейнера, а в репозитории нет E2E deployment-манифеста. Учётные данные тестового бота и публичный тестовый HTTPS endpoint не создаются автоматически.
