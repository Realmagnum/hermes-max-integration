...
**Сделано:** базовая структура mixins, table_renderer (543 строк), media_upload (197 строк со всей логикой upload/CDN); **шаг 7 отменён** — STT делегирован ядру Hermes v0.20.0, миксин `stt_processor.py` удалён (2026-08-05)
